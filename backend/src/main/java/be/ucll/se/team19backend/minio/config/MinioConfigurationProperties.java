 ...
 */
 ...
 package be.ucll.se.team19backend.minio.config;
...
public class MinioConfigurationProperties {
     ...
     */
    private String accessKey = "minio-root-user";

    /**
     * Secret key (password) on Minio instance
     */
    private String secretKey = "minio-root-password";
